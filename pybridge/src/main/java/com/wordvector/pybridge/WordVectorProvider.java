...
public interface WordVectorProvider {
    ...
    /**
     * Implemented, this method should provide the possibility to request a word vector with HTTP request
    ...
    /**
     * Implemented, this method should provide the option to shutdown the python server gracefully.
     * You can use an endpoint on python side.
