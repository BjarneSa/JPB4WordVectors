...
public class AppTest {
    ...
    /**
     * Test on one single vector to word "the". Comparison on entry with index 0.
     * "The" is one o the first entries in model from fasttext based on wikipedia.
     */
    @Test
    ...
    public void testOneVectorFirstIndex() {
        assertEquals(0.11980000138282776, pythonBridge.getVector("Earth").get().getVectorEntry(0), delta);
    }
    ...
    public void testVectorToNumbers() {
        ...
        assertEquals(-0.06270000338554382, pythonBridge.getVector("42").get().getVectorEntry(2), delta);
        assertEquals(-0.023800000548362732, pythonBridge.getVector("1.5").get().getVectorEntry(3), delta);
    }
